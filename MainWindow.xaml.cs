...
public partial class MainWindow : Window
{
    ...
    private async Task InitializeWebView()
    {
        var options = new CoreWebView2EnvironmentOptions(
            "--single-process --disable-gpu --disable-software-rasterizer --disable-background-networking --disable-component-update --disable-default-apps --disable-extensions --disable-sync --no-first-run --no-default-browser-check --disable-popup-blocking --disable-hang-monitor --disable-prompt-on-repost --disable-domain-reliability --disable-features=msEdgeAI,msEdgeAIChat,msEdgeCopilot,msEdgeAIFeatures,msSearch,msEdgeTranslate");
        ...
        var htmlPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "天气插件.html");
        ...
        {
            webView.CoreWebView2.NavigateToString("<html><body style='color:white;text-align:center;padding-top:100px;font-family:sans-serif'><p>找不到天气插件.html</p><p>请将文件放到程序目录</p></body></html>");
        }
    }
}